...
1. 如果你有能力连接 Github，建议使用 Github 源：`https://github.com/wess09/AzurLaneAutoScript`，同时不要忘记在 `GitProxy` 配置稳定的代理。
2. 如果你没有能力连接 Github，或者想自动更新时快一些，建议使用 CN 源。默认 CN 源为 `https://gitee.com/wqeaxc/AzurLaneAutoScript1`
